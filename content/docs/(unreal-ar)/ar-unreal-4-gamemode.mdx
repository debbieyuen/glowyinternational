...
If you are developing for Android, install the [**Google ARCore**](https://dev.epicgames.com/documentation/en-us/unreal-engine/developing-for-arcore-in-unreal-engine) plugin. 
For iOS, install the [**Apple ARKit**](https://dev.epicgames.com/documentation/en-us/unreal-engine/apple-arkit?application_version=4.27).
